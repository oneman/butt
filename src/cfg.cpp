...
const char *lang_array_new[] = {"system", "de", "en", "es", "fr", "pt_BR"};
...
int cfg_write_file(char *path)
{
    ...
    fprintf(cfg_fd,
            ...
            cfg.rec.filename, cfg.rec.silence_threshold, cfg.rec.signal_threshold, cfg.rec.folder);
    ...
    fprintf(cfg_fd,
            ...
            "release = %f\n"
            "makeup_gain = %f\n\n",
            cfg.dsp.equalizer, cfg.dsp.eq_preset, cfg.dsp.eq_gain[0], cfg.dsp.eq_gain[1], cfg.dsp.eq_gain[2], cfg.dsp.eq_gain[3], cfg.dsp.eq_gain[4],
            cfg.dsp.eq_gain[5], cfg.dsp.eq_gain[6], cfg.dsp.eq_gain[7], cfg.dsp.eq_gain[8], cfg.dsp.eq_gain[9], cfg.dsp.compressor, cfg.dsp.aggressive_mode,
            cfg.dsp.threshold, cfg.dsp.ratio, cfg.dsp.attack, cfg.dsp.release, cfg.dsp.makeup_gain);
...
int cfg_set_values(char *path)
{
    ...
    // DSP
    cfg.dsp.equalizer = cfg_get_int("dsp", "equalizer", 0);
    ...
    cfg.dsp.compressor = cfg_get_int("dsp", "compressor", 0);
